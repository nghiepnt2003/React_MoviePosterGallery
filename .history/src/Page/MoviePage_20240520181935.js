  ...
  return (
    <div className="py-10 page-container">
      ...
      {isLoading && (
        <div
          key={123}
          className="w-10 h-10 rounded-full border border-4 border-primary border-t-transparent border-t-4 mx-auto animate-spin mt-10"
        ></div>
      )}
      {!isLoading && (
      ...
      <div className="flex items-center justify-center mt-10 gap-x-5">
        ...
        <span className="cursor-pointer inline-block bg-white leading-none py-2 px-4 rounded text-slate-900">
          1
        </span>
